...
public class AtomixConfigTest {
  ...
  public void testAtomixConfig() throws Exception {
    final AtomixConfig config = Atomix
    ...
    final HeartbeatMembershipProtocolConfig protocol = (HeartbeatMembershipProtocolConfig) cluster
        .getProtocolConfig();
    ...
    final RaftPartitionGroupConfig groupOne = (RaftPartitionGroupConfig) config.getPartitionGroups()
        .get("one");
