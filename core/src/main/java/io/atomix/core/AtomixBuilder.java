 ...
 * <p>
 * This builder is used to configure an {@link Atomix} instance programmatically. To create a new
...
public class AtomixBuilder extends AtomixClusterBuilder {
   ...
   * <p>
   * Profiles are common configurations that will be applied to the instance configuration when the
   * {@link Atomix} instance is constructed.
   *
   ...
   * <p>
   * The primitive partition groups represent partitions that are directly accessible to distributed
   ...
   * <p>
   * The configured partition groups are replicated on whichever nodes define them in this
   * configuration. That is, this node will participate in whichever partition groups are provided
   * to this method.
   * <p>
   * The partition groups can also be configured in {@code atomix.conf} under the {@code
   ...
   * <p>
   * The provided group will be added to the list of already configured partition groups. The
   ...
   * <p>
   * The returned instance will be configured with the initial builder configuration plus any
