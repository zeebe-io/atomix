...
public interface AsyncWorkQueue<E> extends AsyncPrimitive {
   ...
   * @return future for the tasks. The future can be completed with an empty collection if there are
   *     no unassigned tasks in the work queue
   */
   ...
   * @return future that is completed when the operation completes
   */
  CompletableFuture<Void> registerTaskProcessor(
